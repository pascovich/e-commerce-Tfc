     ...
     <div class="col-lg-6">
          <div class="form-group">
            <div class="col-md-12">
              ...
              <div class="col-lg-8"> 
                <input  id="GENDER" name="GENDER"  type="radio" <?php echo ($res->GENDER=='Male') ? 'CHECKED' : '' ;  ?>   value="Male" /><b> Homme </b>
                    <input   id="GENDER"   name="GENDER"   type="radio" <?php echo ($res->GENDER=='Female') ? 'CHECKED' : '' ; ?> value="Female" /> <b> Femme </b>
              </div>
            </div>
          </div>
          </div>
