          ...
          <div id="slider-carousel" class="carousel slide" data-ride="carousel">
            ...
            <div class="carousel-inner">
              <div class="item active">
                <div class="col-sm-6">
                  <h1><span>JIBU E</span>-COMMAND</h1>
                  <h2>E-commerce de commande en ligne</h2>
                  <p>Un bon marketing nécessite que vous donniez à vos clients des raisons rationnelles pour leurs décisions d’achat émotionnelles. </p>
                 
                </div>
                <div class="col-sm-6">
                  <img src="images/home/pricing.png" class="girl img-responsive" alt="" />
                  <img src="images/home/jibu1.jfif"  class="pricing" alt="" />
                </div>
              </div>
              <!-- <div class="item">
                <div class="col-sm-6">
                  <h1><span>IBU E</span>-COMMAND</h1>
                  <h2>100% Making</h2>
              ...
              <div class="item">
                <div class="col-sm-6">
                  <h1><span>E</span>-Livraison</h1>
                  <h2>Livraison a domicile</h2>
                  <p>L’objectif de la vente est de satisfaire un besoin client, celui du marketing est de comprendre ce besoin. </p>
                 
                </div>
                <div class="col-sm-6">
                  <img src="images/home/pricing.jpg" class="girl img-responsive" alt="" />
                  <img src="images/home/jibu2.jfif" class="pricing" alt="" />
                </div>
              </div>
      ...
      <div class="row">
        ...
        <div class="col-sm-9 padding-right">
          <div class="features_items"><!--features_items-->
            <h2 class="title text-center">Caractéristiques Éléments</h2>
