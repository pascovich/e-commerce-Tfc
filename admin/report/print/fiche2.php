...
$rqt2 = $db->query("SELECT (SUM(cote)*100)/sum(maxs) tot FROM `tri_cotation` WHERE enseignant='$enseignant'");
$rqt2->execute();
$result2 = array();
...
while ($fetchdata=$rqt->fetch()) {
	...
	$entete.=' 
		...
		<td></td>
		<td></td>
		<td class="csB63DDD09" colspan="7" style="width:186px;height:20px;line-height:18px;text-align:left;vertical-align:top;"><nobr>ANNEE-ACADEMIQUE&nbsp;&nbsp;&nbsp;&nbsp;:</nobr></td>
		<td></td>
		<td class="csE3FFF3AB" colspan="6" style="width:186px;height:20px;line-height:17px;text-align:left;vertical-align:top;"><nobr>'.$fetchdata['annee'].'</nobr></td>
		<td></td>
		<td></td>
		<td></td>
		<td></td>
	...
	<tr style="vertical-align:top;">
		...
		<td></td>
		<td></td>
		<td class="csB63DDD09" colspan="7" style="width:186px;height:19px;line-height:18px;text-align:left;vertical-align:top;"><nobr>ENSEIGNANT&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:</nobr></td>
		<td></td>
...
while($fetchdata=$rqt1->fetch()){
	...
	$body.=' 
		...
		<td></td>
		<td class="cs5B97A8FB" colspan="4" style="width:89px;height:22px;line-height:16px;text-align:center;vertical-align:middle;"><nobr>'.$iddd.'</nobr></td>
		<td class="csFA62286C" colspan="6" style="width:225px;height:22px;line-height:16px;text-align:center;vertical-align:middle;"><nobr>'.$fetchdata['prom'].'</nobr></td>
		<td class="csFA62286C" colspan="6" style="width:220px;height:22px;line-height:16px;text-align:center;vertical-align:middle;"><nobr>'.$fetchdata['cours'].'</nobr></td>
		<td class="csFA62286C" colspan="5" style="width:124px;height:22px;line-height:16px;text-align:center;vertical-align:middle;"><nobr>'.$fetchdata['percent'].'</nobr></td>
		<td class="csFA62286C" style="width:105px;height:22px;line-height:16px;text-align:center;vertical-align:middle;"><nobr>100%</nobr></td>
		<td></td>
	</tr>
...
$foot='';
while($fetchdata=$rqt2->fetch()){
	$foot.=' 

	<tr style="vertical-align:top;">
		<td style="height:24px;"></td>
		<td></td>
		<td class="cs4F1C6E9A" colspan="16" style="width:536px;height:22px;line-height:19px;text-align:center;vertical-align:middle;"><nobr>TOTAL&nbsp;COTE</nobr></td>
		<td class="cs4C5A98CB" colspan="5" style="width:124px;height:22px;line-height:19px;text-align:center;vertical-align:middle;"><nobr>'.$fetchdata['tot'].' %</nobr></td>
		<td class="cs4C5A98CB" style="width:105px;height:22px;line-height:19px;text-align:center;vertical-align:middle;"><nobr>100%</nobr></td>
		<td></td>
	</tr>
...
<table cellpadding="0" cellspacing="0" border="0" style="border-width:0px;empty-cells:show;width:786px;height:364px;position:relative;">
	<tr style="vertical-align:top;">
	...
	<tr style="vertical-align:top;">
		<td style="height:24px;"></td>
		<td></td>
		<td class="cs4F1C6E9A" colspan="4" style="width:89px;height:22px;line-height:19px;text-align:center;vertical-align:middle;"><nobr>#</nobr></td>
